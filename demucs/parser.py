...
def get_parser():
    ...
    parser.add_argument(
        "--test_pretrained",
        help="Just run the test pipeline + one validation, " "on a pretrained model. ",
    )
    ...
    parser.add_argument(
        "-e", "--epochs", type=int, default=180, help="Number of epochs"
    )
    parser.add_argument(
        "-r",
        "--repeat",
    ...
    parser.add_argument(
        "--no_norm_wav", action="store_false", dest="norm_wav", default=True
    )
    ...
    parser.add_argument(
        "--save_model",
        action="store_true",
        help="Skip traning, just save final model " "for the current checkpoint value.",
    )
    parser.add_argument(
        "--save_state",
